export const Bio = {
    ...
    github: "https://github.com/abhishekdev45",
    resume:
      "https://drive.google.com/file/d/1SNg_-9otJ7pL6jsyuB-0SRPhPOwCz6Y8/view?usp=sharing",
    linkedin: "https://www.linkedin.com/in/abhishek-rajbhar-238620207/",
    insta: "https://www.instagram.com/abhishek_rajbhar_45/",
  ...
  export const experiences = [
    {
      ...
      company: "Webdesys Techno Consultant",
      date: "December 2023 - present",
      desc: "Working on various clients project, managing frontend and development, and streamlining the process with automation.",
      skills: [
        "AWS",
        "EC2",
        "Nginx",
  ...
  export const TimeLineData = [
    { year: 2020, text: "Started my B.tech journey" },
    { year: 2022, text: "Worked as a freelance developer" },
    { year: 2022, text: "started with open source contribution" },
    { year: 2023, text: "Organized a intercollege level hackathon" },
    { year: 2023, text: "Got my first internship at Webdesys" },
  ];